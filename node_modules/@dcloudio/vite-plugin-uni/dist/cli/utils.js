...
function initEnv(type, options) {
    ...
    if (process.env.UNI_PLATFORM === 'app-harmony') {
        ...
        if (projectPath) {
            process.env.UNI_APP_HARMONY_PROJECT_PATH = path_1.default.resolve(projectPath);
            // 指定了鸿蒙项目根目录
            process.env.UNI_OUTPUT_DIR = path_1.default.resolve(process.env.UNI_APP_HARMONY_PROJECT_PATH, `entry/src/main/resources/rawfile/apps/HBuilder/www`);
        }
    }
