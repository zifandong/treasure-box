    ...
    return {
        ...
        config() {
            return {
                base: '/', // 强制 base
                build: {
                    sourcemap: (0, uni_cli_shared_2.enableSourceMap)() ? 'hidden' : false,
                    emptyOutDir: false,
                    assetsInlineLimit: 0,
                    rollupOptions: {
        ...
        generateBundle(_, bundle) {
            ...
            if (appServiceMap && appServiceMap.type === 'asset') {
                fs_extra_1.default.outputFileSync(path_1.default.resolve(process.env.UNI_APP_X_CACHE_DIR, 'sourcemap', APP_SERVICE_FILENAME_MAP), appServiceMap.source);
